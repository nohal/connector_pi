...
void CRESPONSE::SetContainer( CNMEA0183 *container )
{
   container_p = container;
}

void CRESPONSE::SetErrorMessage( const wxString& error_message )
{
...
bool CRESPONSE::Write( SENTENCE& sentence )
{
   /*
...
const wxString& CRESPONSE::PlainEnglish( void )
{
